"""
This is the main function of the reinforcement learning.
It first imports the environment and brain and then run the reinforcement training.
...
if __name__ == "__main__":
    len_max = 300
    env = Env(len_max=len_max, n_fe=60, n_classes=18)
    ...
    # env.mainloop()
    # RL.plot_cost()
    # pickle.dump(RL.cost_his, open("cost_his_unimib", "wb"))
    # pickle.dump(reward_his, open("reward_his_unimib", "wb"))
    # pickle.dump(best_state, open("best_state_unimib", 'wb'))