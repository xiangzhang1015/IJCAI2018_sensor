"""
This part of code is the Dueling DQN brain, which is a brain of the agent.
...
class DeepQNetwork:
    ...
    def learn(self):
        ...
        # increasing epsilon. if epsilon_increment != None,
        # the epsilon will gradually increase, the increment = epsilon_increment
